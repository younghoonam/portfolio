import"./modulepreload-polyfill-B5Qt9EMX.js";import{L as kt,F as Xe,S as Re,a as at,B as rt,b as Ke,C as Q,c as ot,D as Bt,H as ne,d as Oe,e as xe,f as je,O as At,M as Ft,g as Je,h as re,U as He,V as q,W as _e,N as Ht,i as Ut,j as i,A as zt,k as lt,l as Ne,m,n as Nt,P as Wt,o as Gt,p as Vt,q as Qt,r as qt,s as Yt,t as $t,u as Xt,G as Kt,T as jt,v as Jt,w as Zt,E as ei,Q as ti}from"./TransformControls-DY6YtNii.js";import ii from"https://cdn.jsdelivr.net/npm/lil-gui@0.19/+esm";var ve=function(){var n=0,e=document.createElement("div");e.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",e.addEventListener("click",function(g){g.preventDefault(),a(++n%e.children.length)},!1);function t(g){return e.appendChild(g.dom),g}function a(g){for(var w=0;w<e.children.length;w++)e.children[w].style.display=w===g?"block":"none";n=g}var o=(performance||Date).now(),r=o,s=0,c=t(new ve.Panel("FPS","#0ff","#002")),d=t(new ve.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var M=t(new ve.Panel("MB","#f08","#201"));return a(0),{REVISION:16,dom:e,addPanel:t,showPanel:a,begin:function(){o=(performance||Date).now()},end:function(){s++;var g=(performance||Date).now();if(d.update(g-o,200),g>=r+1e3&&(c.update(s*1e3/(g-r),100),r=g,s=0,M)){var w=performance.memory;M.update(w.usedJSHeapSize/1048576,w.jsHeapSizeLimit/1048576)}return g},update:function(){o=this.end()},domElement:e,setMode:a}};ve.Panel=function(n,e,t){var a=1/0,o=0,r=Math.round,s=r(window.devicePixelRatio||1),c=80*s,d=48*s,M=3*s,g=2*s,w=3*s,v=15*s,x=74*s,O=30*s,B=document.createElement("canvas");B.width=c,B.height=d,B.style.cssText="width:80px;height:48px";var S=B.getContext("2d");return S.font="bold "+9*s+"px Helvetica,Arial,sans-serif",S.textBaseline="top",S.fillStyle=t,S.fillRect(0,0,c,d),S.fillStyle=e,S.fillText(n,M,g),S.fillRect(w,v,x,O),S.fillStyle=t,S.globalAlpha=.9,S.fillRect(w,v,x,O),{dom:B,update:function(F,K){a=Math.min(a,F),o=Math.max(o,F),S.fillStyle=t,S.globalAlpha=1,S.fillRect(0,0,c,v),S.fillStyle=e,S.fillText(r(F)+" "+n+" ("+r(a)+"-"+r(o)+")",M,g),S.drawImage(B,w+s,v,x-s,O,w,v,x-s,O),S.fillRect(w+x-s,v,s,O),S.fillStyle=t,S.globalAlpha=.9,S.fillRect(w+x-s,v,s,r((1-F/K)*O))}}};const ke=new WeakMap;class ni extends kt{constructor(e){super(e),this.decoderPath="",this.decoderConfig={},this.decoderBinary=null,this.decoderPending=null,this.workerLimit=4,this.workerPool=[],this.workerNextTaskID=1,this.workerSourceURL="",this.defaultAttributeIDs={position:"POSITION",normal:"NORMAL",color:"COLOR",uv:"TEX_COORD"},this.defaultAttributeTypes={position:"Float32Array",normal:"Float32Array",color:"Float32Array",uv:"Float32Array"}}setDecoderPath(e){return this.decoderPath=e,this}setDecoderConfig(e){return this.decoderConfig=e,this}setWorkerLimit(e){return this.workerLimit=e,this}load(e,t,a,o){const r=new Xe(this.manager);r.setPath(this.path),r.setResponseType("arraybuffer"),r.setRequestHeader(this.requestHeader),r.setWithCredentials(this.withCredentials),r.load(e,s=>{this.parse(s,t,o)},a,o)}parse(e,t,a=()=>{}){this.decodeDracoFile(e,t,null,null,Re,a).catch(a)}decodeDracoFile(e,t,a,o,r=at,s=()=>{}){const c={attributeIDs:a||this.defaultAttributeIDs,attributeTypes:o||this.defaultAttributeTypes,useUniqueIDs:!!a,vertexColorSpace:r};return this.decodeGeometry(e,c).then(t).catch(s)}decodeGeometry(e,t){const a=JSON.stringify(t);if(ke.has(e)){const d=ke.get(e);if(d.key===a)return d.promise;if(e.byteLength===0)throw new Error("THREE.DRACOLoader: Unable to re-decode a buffer with different settings. Buffer has already been transferred.")}let o;const r=this.workerNextTaskID++,s=e.byteLength,c=this._getWorker(r,s).then(d=>(o=d,new Promise((M,g)=>{o._callbacks[r]={resolve:M,reject:g},o.postMessage({type:"decode",id:r,taskConfig:t,buffer:e},[e])}))).then(d=>this._createGeometry(d.geometry));return c.catch(()=>!0).then(()=>{o&&r&&this._releaseTask(o,r)}),ke.set(e,{key:a,promise:c}),c}_createGeometry(e){const t=new rt;e.index&&t.setIndex(new Ke(e.index.array,1));for(let a=0;a<e.attributes.length;a++){const o=e.attributes[a],r=o.name,s=o.array,c=o.itemSize,d=new Ke(s,c);r==="color"&&(this._assignVertexColorSpace(d,o.vertexColorSpace),d.normalized=!(s instanceof Float32Array)),t.setAttribute(r,d)}return t}_assignVertexColorSpace(e,t){if(t!==Re)return;const a=new Q;for(let o=0,r=e.count;o<r;o++)a.fromBufferAttribute(e,o),ot.toWorkingColorSpace(a,Re),e.setXYZ(o,a.r,a.g,a.b)}_loadLibrary(e,t){const a=new Xe(this.manager);return a.setPath(this.decoderPath),a.setResponseType(t),a.setWithCredentials(this.withCredentials),new Promise((o,r)=>{a.load(e,o,void 0,r)})}preload(){return this._initDecoder(),this}_initDecoder(){if(this.decoderPending)return this.decoderPending;const e=typeof WebAssembly!="object"||this.decoderConfig.type==="js",t=[];return e?t.push(this._loadLibrary("draco_decoder.js","text")):(t.push(this._loadLibrary("draco_wasm_wrapper.js","text")),t.push(this._loadLibrary("draco_decoder.wasm","arraybuffer"))),this.decoderPending=Promise.all(t).then(a=>{const o=a[0];e||(this.decoderConfig.wasmBinary=a[1]);const r=si.toString(),s=["/* draco decoder */",o,"","/* worker */",r.substring(r.indexOf("{")+1,r.lastIndexOf("}"))].join(`
`);this.workerSourceURL=URL.createObjectURL(new Blob([s]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){const o=new Worker(this.workerSourceURL);o._callbacks={},o._taskCosts={},o._taskLoad=0,o.postMessage({type:"init",decoderConfig:this.decoderConfig}),o.onmessage=function(r){const s=r.data;switch(s.type){case"decode":o._callbacks[s.id].resolve(s);break;case"error":o._callbacks[s.id].reject(s);break;default:console.error('THREE.DRACOLoader: Unexpected message, "'+s.type+'"')}},this.workerPool.push(o)}else this.workerPool.sort(function(o,r){return o._taskLoad>r._taskLoad?-1:1});const a=this.workerPool[this.workerPool.length-1];return a._taskCosts[e]=t,a._taskLoad+=t,a})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log("Task load: ",this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==""&&URL.revokeObjectURL(this.workerSourceURL),this}}function si(){let n,e;onmessage=function(s){const c=s.data;switch(c.type){case"init":n=c.decoderConfig,e=new Promise(function(g){n.onModuleLoaded=function(w){g({draco:w})},DracoDecoderModule(n)});break;case"decode":const d=c.buffer,M=c.taskConfig;e.then(g=>{const w=g.draco,v=new w.Decoder;try{const x=t(w,v,new Int8Array(d),M),O=x.attributes.map(B=>B.array.buffer);x.index&&O.push(x.index.array.buffer),self.postMessage({type:"decode",id:c.id,geometry:x},O)}catch(x){console.error(x),self.postMessage({type:"error",id:c.id,error:x.message})}finally{w.destroy(v)}});break}};function t(s,c,d,M){const g=M.attributeIDs,w=M.attributeTypes;let v,x;const O=c.GetEncodedGeometryType(d);if(O===s.TRIANGULAR_MESH)v=new s.Mesh,x=c.DecodeArrayToMesh(d,d.byteLength,v);else if(O===s.POINT_CLOUD)v=new s.PointCloud,x=c.DecodeArrayToPointCloud(d,d.byteLength,v);else throw new Error("THREE.DRACOLoader: Unexpected geometry type.");if(!x.ok()||v.ptr===0)throw new Error("THREE.DRACOLoader: Decoding failed: "+x.error_msg());const B={index:null,attributes:[]};for(const S in g){const F=self[w[S]];let K,ie;if(M.useUniqueIDs)ie=g[S],K=c.GetAttributeByUniqueId(v,ie);else{if(ie=c.GetAttributeId(v,s[g[S]]),ie===-1)continue;K=c.GetAttribute(v,ie)}const se=o(s,c,v,S,F,K);S==="color"&&(se.vertexColorSpace=M.vertexColorSpace),B.attributes.push(se)}return O===s.TRIANGULAR_MESH&&(B.index=a(s,c,v)),s.destroy(v),B}function a(s,c,d){const g=d.num_faces()*3,w=g*4,v=s._malloc(w);c.GetTrianglesUInt32Array(d,w,v);const x=new Uint32Array(s.HEAPF32.buffer,v,g).slice();return s._free(v),{array:x,itemSize:1}}function o(s,c,d,M,g,w){const v=w.num_components(),O=d.num_points()*v,B=O*g.BYTES_PER_ELEMENT,S=r(s,g),F=s._malloc(B);c.GetAttributeDataArrayForAllPoints(d,w,S,B,F);const K=new g(s.HEAPF32.buffer,F,O).slice();return s._free(F),{name:M,array:K,itemSize:v}}function r(s,c){switch(c){case Float32Array:return s.DT_FLOAT32;case Int8Array:return s.DT_INT8;case Int16Array:return s.DT_INT16;case Int32Array:return s.DT_INT32;case Uint8Array:return s.DT_UINT8;case Uint16Array:return s.DT_UINT16;case Uint32Array:return s.DT_UINT32}}}class ai extends Bt{constructor(e){super(e),this.type=ne}parse(e){const s=function(p,b){switch(p){case 1:throw new Error("THREE.RGBELoader: Read Error: "+(b||""));case 2:throw new Error("THREE.RGBELoader: Write Error: "+(b||""));case 3:throw new Error("THREE.RGBELoader: Bad File Format: "+(b||""));default:case 4:throw new Error("THREE.RGBELoader: Memory Error: "+(b||""))}},g=`
`,w=function(p,b,P){b=b||1024;let I=p.pos,L=-1,y=0,R="",_=String.fromCharCode.apply(null,new Uint16Array(p.subarray(I,I+128)));for(;0>(L=_.indexOf(g))&&y<b&&I<p.byteLength;)R+=_,y+=_.length,I+=128,_+=String.fromCharCode.apply(null,new Uint16Array(p.subarray(I,I+128)));return-1<L?(p.pos+=y+L+1,R+_.slice(0,L)):!1},v=function(p){const b=/^#\?(\S+)/,P=/^\s*GAMMA\s*=\s*(\d+(\.\d+)?)\s*$/,C=/^\s*EXPOSURE\s*=\s*(\d+(\.\d+)?)\s*$/,I=/^\s*FORMAT=(\S+)\s*$/,L=/^\s*\-Y\s+(\d+)\s+\+X\s+(\d+)\s*$/,y={valid:0,string:"",comments:"",programtype:"RGBE",format:"",gamma:1,exposure:1,width:0,height:0};let R,_;for((p.pos>=p.byteLength||!(R=w(p)))&&s(1,"no header found"),(_=R.match(b))||s(3,"bad initial token"),y.valid|=1,y.programtype=_[1],y.string+=R+`
`;R=w(p),R!==!1;){if(y.string+=R+`
`,R.charAt(0)==="#"){y.comments+=R+`
`;continue}if((_=R.match(P))&&(y.gamma=parseFloat(_[1])),(_=R.match(C))&&(y.exposure=parseFloat(_[1])),(_=R.match(I))&&(y.valid|=2,y.format=_[1]),(_=R.match(L))&&(y.valid|=4,y.height=parseInt(_[1],10),y.width=parseInt(_[2],10)),y.valid&2&&y.valid&4)break}return y.valid&2||s(3,"missing format specifier"),y.valid&4||s(3,"missing image size specifier"),y},x=function(p,b,P){const C=b;if(C<8||C>32767||p[0]!==2||p[1]!==2||p[2]&128)return new Uint8Array(p);C!==(p[2]<<8|p[3])&&s(3,"wrong scanline width");const I=new Uint8Array(4*b*P);I.length||s(4,"unable to allocate buffer space");let L=0,y=0;const R=4*C,_=new Uint8Array(4),he=new Uint8Array(R);let Ye=P;for(;Ye>0&&y<p.byteLength;){y+4>p.byteLength&&s(1),_[0]=p[y++],_[1]=p[y++],_[2]=p[y++],_[3]=p[y++],(_[0]!=2||_[1]!=2||(_[2]<<8|_[3])!=C)&&s(3,"bad rgbe scanline format");let ge=0,Z;for(;ge<R&&y<p.byteLength;){Z=p[y++];const ee=Z>128;if(ee&&(Z-=128),(Z===0||ge+Z>R)&&s(3,"bad scanline data"),ee){const te=p[y++];for(let $e=0;$e<Z;$e++)he[ge++]=te}else he.set(p.subarray(y,y+Z),ge),ge+=Z,y+=Z}const Ot=C;for(let ee=0;ee<Ot;ee++){let te=0;I[L]=he[ee+te],te+=C,I[L+1]=he[ee+te],te+=C,I[L+2]=he[ee+te],te+=C,I[L+3]=he[ee+te],L+=4}Ye--}return I},O=function(p,b,P,C){const I=p[b+3],L=Math.pow(2,I-128)/255;P[C+0]=p[b+0]*L,P[C+1]=p[b+1]*L,P[C+2]=p[b+2]*L,P[C+3]=1},B=function(p,b,P,C){const I=p[b+3],L=Math.pow(2,I-128)/255;P[C+0]=xe.toHalfFloat(Math.min(p[b+0]*L,65504)),P[C+1]=xe.toHalfFloat(Math.min(p[b+1]*L,65504)),P[C+2]=xe.toHalfFloat(Math.min(p[b+2]*L,65504)),P[C+3]=xe.toHalfFloat(1)},S=new Uint8Array(e);S.pos=0;const F=v(S),K=F.width,ie=F.height,se=x(S.subarray(S.pos),K,ie);let Le,Ie,ce;switch(this.type){case Oe:ce=se.length/4;const p=new Float32Array(ce*4);for(let P=0;P<ce;P++)O(se,P*4,p,P*4);Le=p,Ie=Oe;break;case ne:ce=se.length/4;const b=new Uint16Array(ce*4);for(let P=0;P<ce;P++)B(se,P*4,b,P*4);Le=b,Ie=ne;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:K,height:ie,data:Le,header:F.string,gamma:F.gamma,exposure:F.exposure,type:Ie}}setDataType(e){return this.type=e,this}load(e,t,a,o){function r(s,c){switch(s.type){case Oe:case ne:s.colorSpace=at,s.minFilter=je,s.magFilter=je,s.generateMipmaps=!1,s.flipY=!0;break}t&&t(s,c)}return super.load(e,r,a,o)}}const ct={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class Se{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const ri=new At(-1,1,1,-1,0,1);class oi extends rt{constructor(){super(),this.setAttribute("position",new Je([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Je([0,2,0,0,2,0],2))}}const li=new oi;class ht{constructor(e){this._mesh=new Ft(li,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,ri)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class We extends Se{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof re?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=He.clone(e.uniforms),this.material=new re({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new ht(this.material)}render(e,t,a){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=a.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Ze extends Se{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,a){const o=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let s,c;this.inverse?(s=0,c=1):(s=1,c=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(o.REPLACE,o.REPLACE,o.REPLACE),r.buffers.stencil.setFunc(o.ALWAYS,s,4294967295),r.buffers.stencil.setClear(c),r.buffers.stencil.setLocked(!0),e.setRenderTarget(a),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(o.EQUAL,1,4294967295),r.buffers.stencil.setOp(o.KEEP,o.KEEP,o.KEEP),r.buffers.stencil.setLocked(!0)}}class ci extends Se{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class dt{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const a=e.getSize(new q);this._width=a.width,this._height=a.height,t=new _e(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:ne}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new We(ct),this.copyPass.material.blending=Ht,this.clock=new Ut}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let a=!1;for(let o=0,r=this.passes.length;o<r;o++){const s=this.passes[o];if(s.enabled!==!1){if(s.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(o),s.render(this.renderer,this.writeBuffer,this.readBuffer,e,a),s.needsSwap){if(a){const c=this.renderer.getContext(),d=this.renderer.state.buffers.stencil;d.setFunc(c.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),d.setFunc(c.EQUAL,1,4294967295)}this.swapBuffers()}Ze!==void 0&&(s instanceof Ze?a=!0:s instanceof ci&&(a=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new q);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const a=this._width*this._pixelRatio,o=this._height*this._pixelRatio;this.renderTarget1.setSize(a,o),this.renderTarget2.setSize(a,o);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(a,o)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class hi extends Se{constructor(e,t,a=null,o=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=a,this.clearColor=o,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Q}render(e,t,a){const o=e.autoClear;e.autoClear=!1;let r,s;this.overrideMaterial!==null&&(s=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:a),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=s),e.autoClear=o}}const di={name:"LuminosityHighPassShader",shaderID:"luminosityHighPass",uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Q(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`};class fe extends Se{constructor(e,t,a,o){super(),this.strength=t!==void 0?t:1,this.radius=a,this.threshold=o,this.resolution=e!==void 0?new q(e.x,e.y):new q(256,256),this.clearColor=new Q(0,0,0),this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let r=Math.round(this.resolution.x/2),s=Math.round(this.resolution.y/2);this.renderTargetBright=new _e(r,s,{type:ne}),this.renderTargetBright.texture.name="UnrealBloomPass.bright",this.renderTargetBright.texture.generateMipmaps=!1;for(let w=0;w<this.nMips;w++){const v=new _e(r,s,{type:ne});v.texture.name="UnrealBloomPass.h"+w,v.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(v);const x=new _e(r,s,{type:ne});x.texture.name="UnrealBloomPass.v"+w,x.texture.generateMipmaps=!1,this.renderTargetsVertical.push(x),r=Math.round(r/2),s=Math.round(s/2)}const c=di;this.highPassUniforms=He.clone(c.uniforms),this.highPassUniforms.luminosityThreshold.value=o,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new re({uniforms:this.highPassUniforms,vertexShader:c.vertexShader,fragmentShader:c.fragmentShader}),this.separableBlurMaterials=[];const d=[3,5,7,9,11];r=Math.round(this.resolution.x/2),s=Math.round(this.resolution.y/2);for(let w=0;w<this.nMips;w++)this.separableBlurMaterials.push(this.getSeperableBlurMaterial(d[w])),this.separableBlurMaterials[w].uniforms.invSize.value=new q(1/r,1/s),r=Math.round(r/2),s=Math.round(s/2);this.compositeMaterial=this.getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;const M=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=M,this.bloomTintColors=[new i(1,1,1),new i(1,1,1),new i(1,1,1),new i(1,1,1),new i(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors;const g=ct;this.copyUniforms=He.clone(g.uniforms),this.blendMaterial=new re({uniforms:this.copyUniforms,vertexShader:g.vertexShader,fragmentShader:g.fragmentShader,blending:zt,depthTest:!1,depthWrite:!1,transparent:!0}),this.enabled=!0,this.needsSwap=!1,this._oldClearColor=new Q,this.oldClearAlpha=1,this.basic=new lt,this.fsQuad=new ht(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this.basic.dispose(),this.fsQuad.dispose()}setSize(e,t){let a=Math.round(e/2),o=Math.round(t/2);this.renderTargetBright.setSize(a,o);for(let r=0;r<this.nMips;r++)this.renderTargetsHorizontal[r].setSize(a,o),this.renderTargetsVertical[r].setSize(a,o),this.separableBlurMaterials[r].uniforms.invSize.value=new q(1/a,1/o),a=Math.round(a/2),o=Math.round(o/2)}render(e,t,a,o,r){e.getClearColor(this._oldClearColor),this.oldClearAlpha=e.getClearAlpha();const s=e.autoClear;e.autoClear=!1,e.setClearColor(this.clearColor,0),r&&e.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this.fsQuad.material=this.basic,this.basic.map=a.texture,e.setRenderTarget(null),e.clear(),this.fsQuad.render(e)),this.highPassUniforms.tDiffuse.value=a.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this.fsQuad.material=this.materialHighPassFilter,e.setRenderTarget(this.renderTargetBright),e.clear(),this.fsQuad.render(e);let c=this.renderTargetBright;for(let d=0;d<this.nMips;d++)this.fsQuad.material=this.separableBlurMaterials[d],this.separableBlurMaterials[d].uniforms.colorTexture.value=c.texture,this.separableBlurMaterials[d].uniforms.direction.value=fe.BlurDirectionX,e.setRenderTarget(this.renderTargetsHorizontal[d]),e.clear(),this.fsQuad.render(e),this.separableBlurMaterials[d].uniforms.colorTexture.value=this.renderTargetsHorizontal[d].texture,this.separableBlurMaterials[d].uniforms.direction.value=fe.BlurDirectionY,e.setRenderTarget(this.renderTargetsVertical[d]),e.clear(),this.fsQuad.render(e),c=this.renderTargetsVertical[d];this.fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,e.setRenderTarget(this.renderTargetsHorizontal[0]),e.clear(),this.fsQuad.render(e),this.fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,r&&e.state.buffers.stencil.setTest(!0),this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(a),this.fsQuad.render(e)),e.setClearColor(this._oldClearColor,this.oldClearAlpha),e.autoClear=s}getSeperableBlurMaterial(e){const t=[];for(let a=0;a<e;a++)t.push(.39894*Math.exp(-.5*a*a/(e*e))/e);return new re({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new q(.5,.5)},direction:{value:new q(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`varying vec2 vUv;
				void main() {
					vUv = uv;
					gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );
				...
				}`})}getCompositeMaterial(e){return new re({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`varying vec2 vUv;
				void main() {
					vUv = uv;
					gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );
